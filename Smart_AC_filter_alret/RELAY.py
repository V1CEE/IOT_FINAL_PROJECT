...
class Mqtt_client():
    ...
    def __init__(self):
        # broker IP address:
        self.broker = broker_ip  # From mqtt_init.py
        self.topic = ''
        self.port = int(broker_port)  # From mqtt_init.py
        self.clientname = clientname
        self.username = username  # From mqtt_init.py
        self.password = password  # From mqtt_init.py
        self.subscribeTopic = relay_topic
        self.publishTopic = ''
        self.publishMessage = ''
...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self, mc):
        ...
        self.eHostInput.setText(self.mc.broker)

        self.ePort = QLineEdit()
        self.ePort.setValidator(QIntValidator())
        self.ePort.setMaxLength(4)
        self.ePort.setText(str(self.mc.port))

        self.eClientID = QLineEdit()
        global clientname
        self.eClientID.setText(self.mc.clientname)

        self.eUserName = QLineEdit()
        self.eUserName.setText(self.mc.username)

        self.ePassword = QLineEdit()
        self.ePassword.setEchoMode(QLineEdit.Password)
        self.ePassword.setText(self.mc.password)
        ...
        self.eSubscribeTopic.setText(self.mc.subscribeTopic)
